...
ALARM_PATH := vendor/stellar/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/stellar/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/stellar/prebuilt/common/media/audio/ringtones
...
PRODUCT_COPY_FILES += \
    ...
    $(RINGTONE_PATH)/JesusVibing.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ringtones/JesusVibing.ogg \
